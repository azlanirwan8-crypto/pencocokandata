  ...
  return (
    ...
    >
        ...
        <div style={{ padding: '1.25rem 1.4rem', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '1.15rem' }}>
          ...
          >
            <CheckCircle2 size={18} color="#0ab39c" style={{ flexShrink: 0 }} />
            <div>
          ...
          <div>
            <h4 style={{ fontSize: '0.86rem', fontWeight: 700, color: '#212529', margin: '0 0 0.65rem 0' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem' }}>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem' }}>
                    <strong style={{ fontSize: '0.82rem', color: '#212529' }}>Pengecekan Pertama: Kelurahan Sama</strong>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem' }}>
                    <strong style={{ fontSize: '0.82rem', color: '#212529' }}>Jika Tidak Ada: Kelurahan Terdekat</strong>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem' }}>
                    <strong style={{ fontSize: '0.82rem', color: '#212529' }}>Jika Tidak Juga: Cek Kecamatan Sama</strong>
                    <span style={{ fontSize: '0.7rem', fontWeight: 700, color: '#d68b0c', background: 'rgba(247, 184, 75, 0.2)', padding: '0.1rem 0.45rem', borderRadius: '4px' }}>
                      Skor 75% - 84%
                    </span>
                  </div>
                  <p style={{ fontSize: '0.74rem', color: '#878a99', margin: '0.15rem 0 0 0' }}>
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem' }}>
                    <strong style={{ fontSize: '0.82rem', color: '#212529' }}>Cek Kota / Kabupaten (Dati II)</strong>
