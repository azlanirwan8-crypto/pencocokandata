...
export const SINYAL_PENCOCOKAN: {
  ...
  { no: 6, emoji: '📊', judul: 'Tri-gram Cosine', warna: '#6559cc', deskripsi: 'Vektor potongan tiga huruf: tahan pada nama outlet panjang dan beda spasi/tanda strip.', penjelasan: 'Mengecek potongan tiga huruf — kuat untuk nama panjang dan perbedaan spasi/tanda baca. Baris masuk daftar ini karena kecocokannya terbukti lewat pengecek ini.' },
  { no: 7, emoji: '🧬', judul: 'Longest Common Subsequence', warna: '#6559cc', deskripsi: 'Ketahanan terhadap sisipan kata alamat di tengah nama.', penjelasan: 'Mengecek urutan huruf dan tahan bila ada kata sisipan di tengah nama. Baris masuk daftar ini karena kecocokannya terbukti lewat pengecek ini.' },
  { no: 8, emoji: '🎨', judul: 'Ratcliff-Obershelp (Gestalt)', warna: '#6559cc', deskripsi: 'Kemiripan sebagaimana dinilai manusia, bukan sekadar hitung beda huruf.', penjelasan: 'Menilai kemiripan dengan cara seperti manusia menilai, bukan sekadar menghitung beda huruf. Baris masuk daftar ini karena kecocokannya terbukti lewat penilaian ini.' },
