// SATU TEMPAT, SENGAJA DI SINI: fungsi serverless Vercel tidak bisa mengimpor modul dari
// luar folder api/, dan MENAMBAHKAN file baru di api/ membuat deployment macet diam
// (terukur dua kali: server/rest.ts -> semua /api/* 500; api/_db.ts/api/rest.ts baru ->
// build tidak pernah mendarat). Jadi klien PostgREST di bawah ini ditumpang-tindihkan ke
// file fungsi yang sudah ada, dan api/* yang lain mengimpor dari "./status".
